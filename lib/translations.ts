...
export const translations: Record<Language, Translations> = {
  sk: {
    ...
    features: {
      ...
      feature1: {
        ...
        description: "Staviame moderné klimatizované skladovacie jednotky, ktoré udržiavajú optimálnu teplotu a vlhkosť pre ochranu vašich cenných vecí.",
      ...
      feature2: {
        ...
        description: "Zabezpečujeme pokročilé bezpečnostné systémy a kontrolovaný prístup pre ochranu vašich vecí 24 hodín denne.",
      ...
      feature3: {
        title: "Flexibilné možnosti výstavby",
        description: "Vyberte si z rôznych veľkostí jednotiek a možností výstavby, ktoré vyhovujú vašim potrebám, s jednoduchým online riadením projektov.",
        advantage1: "Rôzne veľkosti jednotiek od 5x5 do 10x30",
        advantage2: "Flexibilné možnosti výstavby",
        advantage3: "Online riadenie projektov a komunikácia",
      },
    },
    stats: {
      label: "Služby",
    ...
    footer: {
      ...
      description: "Bezpečné a pohodlné skladovacie riešenia pre všetky vaše potreby. Klimatizované jednotky, 24/7 bezpečnosť a flexibilné možnosti výstavby.",
      services: {
        title: "Služby",
        items: {
          climateControl: "Klimatizované skladovanie",
          security: "24/7 Bezpečnosť",
          flexibleRental: "Flexibilná výstavba",
  ...
  en: {
    ...
    features: {
      ...
      description: "Experience the difference with our modern facilities, advanced security systems, and flexible construction options tailored to meet all your storage needs.",
      feature1: {
        title: "Climate-Controlled Storage Units",
        description: "We build state-of-the-art climate-controlled storage units that maintain optimal temperature and humidity levels to protect your valuable belongings.",
      ...
      feature2: {
        ...
        description: "We implement advanced security systems and controlled access to protect your belongings around the clock.",
      ...
      feature3: {
        title: "Flexible Construction Options",
        description: "Choose from various unit sizes and construction options that fit your needs, with easy online project management.",
        advantage1: "Multiple unit sizes from 5x5 to 10x30",
        advantage2: "Flexible construction agreements",
        advantage3: "Online project management and communication",
      },
    },
    stats: {
      label: "Services",
    ...
    footer: {
      companyName: "DSSCompany",
      description: "Secure and convenient storage solutions for all your needs. Climate-controlled units, 24/7 security, and flexible construction options.",
      services: {
        title: "Services",
        items: {
          climateControl: "Climate-Controlled Storage",
          security: "24/7 Security",
          flexibleRental: "Flexible Construction",
  ...
  de: {
    ...
    features: {
      ...
      description: "Erleben Sie den Unterschied mit unseren modernen Einrichtungen, fortschrittlichen Sicherheitssystemen und flexiblen Bauoptionen, die auf alle Ihre Lagerbedürfnisse zugeschnitten sind.",
      feature1: {
        title: "Klimatisierte Lagerungseinheiten",
        description: "Wir bauen moderne klimatisierte Lagerungseinheiten, die optimale Temperatur und Luftfeuchtigkeit aufrechterhalten, um Ihre wertvollen Sachen zu schützen.",
      ...
      feature2: {
        ...
        description: "Wir implementieren fortschrittliche Sicherheitssysteme und kontrollierten Zugang, um Ihre Sachen rund um die Uhr zu schützen.",
      ...
      feature3: {
        title: "Flexible Bauoptionen",
        description: "Wählen Sie aus verschiedenen Einheitsgrößen und Bauoptionen, die Ihren Bedürfnissen entsprechen, mit einfachem Online-Projektmanagement.",
        advantage1: "Verschiedene Einheitsgrößen von 5x5 bis 10x30",
        advantage2: "Flexible Bauverträge",
        advantage3: "Online-Projektmanagement und Kommunikation",
      },
    },
    stats: {
    ...
    footer: {
      companyName: "DSSCompany",
      description: "Sichere und bequeme Lagerlösungen für alle Ihre Bedürfnisse. Klimatisierte Einheiten, 24/7 Sicherheit und flexible Bauoptionen.",
      services: {
        title: "Dienstleistungen",
        items: {
          climateControl: "Klimatisierte Lagerung",
          security: "24/7 Sicherheit",
          flexibleRental: "Flexible Bau",
